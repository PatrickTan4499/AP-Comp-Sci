 ...
 * 16 October 2016
 * Magpie chatbot is an interactive chatbot that responds to userinputs.
 * looks for keywords in userinputs and responds to certain keywords in certain predetermined ways
 */
public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "Ms. Ronina") >= 0
				|| findKeyword(statement, "Ms. Dreyer") >= 0
				|| findKeyword(statement, "Ms. Louie") >= 0
				|| findKeyword(statement, "Mr. Phillips") >= 0) {
		...
		} else if(findKeyword(statement, "monica") >= 0){
		response = "kill yourself";
		}else if(findKeyword(statement, "harambe") >=0 ){
		...
		// responds to I want something statements
		else if (findKeyword(statement, "I want to", 0) >= 0) {
			response = transformIWantToStatement(statement);
		}
		// responds to I something you statements
	...
	//I want something method to respond to "I want something" statements
	...
	private String transformYouMeStatement(String statement) {
		...
		// remove the final question mark, if there is one
		if(lastChar.equals("?")) {
			statement = statement.substring(0, statement.length() - 1);
		}
